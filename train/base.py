...
class DataCore(WarpCore):
    ...
    def setup_data(self, extras: Extras) -> WarpCore.Data:
        ...
        dataloader = DataLoader(
            dataset, batch_size=real_batch_size, num_workers=8, pin_memory=True, shuffle=False,
    ...
    def get_conditions(self, batch: dict, models: Models, extras: Extras, is_eval=False, is_unconditional=False,
        ...
        text_embeddings = None
        text_pooled_embeddings = None
        if ('clip_text' in return_fields or 'clip_text_pooled' in return_fields) and models.tokenizer is not None:
            if is_eval:
                if is_unconditional:
            ...
            print("Skipping text embeddings")
